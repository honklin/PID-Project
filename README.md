...
However, I noticed that I had to adjust the output limits when we changed batteries because the motor would need a faster or slower speed to be able to lift the ball than it had before because it was being supplied with higher or lower voltages.
...
Different angles of our CAD design
